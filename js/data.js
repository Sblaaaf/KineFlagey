...
const teamMembers = {
    1: {
        name: 'Gilles Piraux',
        specialties: 'Kiné du sport, Ostéopathe',
        photo: '/assets/images/GILLES_blob.png',
        description: 'Prise en charge globale et centrée sur la rééducation active pour un retour rapide et durable à vos activités.',
        contact: {
            email: 'g.piraux@kineflagey.be',
            phone: '0470 12 34 56',
    ...
    4: {
        ...
        photo: '/assets/images/Fanny_blob.png',
    ...
    5: {
        ...
        photo: '/assets/images/Simon_blob.png',
        ...
        contact: {
            ...
            phone: '0474 56 78 90',
            rosaLink: 'https://rosa.be/fr/s/simon-leclef'
        }
    },
    6: {
        name: 'Mathilde Escoyez',
        specialties: 'Kiné générale, Thérapie manuelle',
        photo: '/assets/images/Mathilde_blob.png',
    ...
    7: {
        ...
        photo: '/assets/images/Thomas_blob.png',
    ...
    8: {
        ...
        photo: '/assets/images/Marie-Ines_blob.png',
    ...
    9: {
        ...
        specialties: 'Kiné générale',
        photo: '/assets/images/Anne-Sophie_blob.png',
